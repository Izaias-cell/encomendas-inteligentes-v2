...
app.post("/api/admin/users", async (req, res) => {
  ...
  console.log("[DEBUG BACKEND] Criando novo usu\xE1rio:", { email, full_name, role, condominium_id, escala_tipo });
...
var handleUpdateAdminUser = async (req, res) => {
  ...
  console.log("[DEBUG BACKEND] Atualizando usu\xE1rio:", id, { full_name, phone, role, condominium_id, active, horario_inicio, horario_fim, escala_tipo });
  ...
  try {
    ...
    if (escala_tipo !== void 0) updateData.escala_tipo = escala_tipo || null;
